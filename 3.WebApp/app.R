            ...
            tabsetPanel(
                ...
                tabPanel("Sobre la aplicación",
                         HTML("<br>
                              ...
                              <a href='https://github.com/malopezgonzalez/Detector-de-fraude-en-leche'>github.com/malopezgonzalez/Detector-de-fraude-en-leche</a><br>
                              <br>
                              ...
                              <li>Santiago Gonzales Berruga con su <a href='https://github.com/DamarisA91/Predictor_de_la_salud_lumbar/blob/main/App/app.R'> Liver disease predictor<a>:</li>
                ...
                tabPanel("Datos para probar la aplicación",
                         HTML("<br>
                              ...
                              de especiación (esp) o bien para la funcionalidad de adulteración (adu). Podéis encontrar un archivo
                              (<i>readme.txt</i>) dónde se describe la codificación de decimales y separadores de columna de cada archivo,
                              así como la función y características de cada archivo.<br>
                              <br>
                              </p>"),
